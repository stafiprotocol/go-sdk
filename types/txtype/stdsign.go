...
func StdSignBytes(chainID string, accnum int64, sequence int64, msgs []msgtype.Msg, memo string, source int64, data []byte) []byte {
	...
	return msgtype.MustSortJSON(bz)
}
