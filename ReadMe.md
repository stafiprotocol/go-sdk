...
Add "github.com/stafiprotocol/go-sdk" dependency into your go.mod file. Example:
```go
require (
	github.com/stafiprotocol/go-sdk latest
)
...
```GO
import sdk "github.com/stafiprotocol/go-sdk/client"
...
For more API usage documentation, please check the [wiki](https://github.com/stafiprotocol/go-sdk/wiki)..
